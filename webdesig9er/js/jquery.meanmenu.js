!function (e) {
  ...
  e.fn.meanmenu = function (n) {
    var a = {
      ...
      meanDisplay: 'block',
      removeElements: '',
      siteLogo: "<a class='navbar-brand img-responsive p-0' href='https://www.webdesig9er.com/' title='WEBDESIGNER LOGO | Best Web Designing Company in Delhi, India LOGO'><img src='images/brand-logo-m.png' alt='WEBDESIGNER LOGO | Best Web Designing Company in Delhi, India LOGO'></a>"
    };
    n = e.extend(a, n);
      ...
      b = function () {
        ...
        if (o >= t) {
          ...
          v ? d ? (jQuery('.mean-nav ul ul').each(function () {
            ...
            e.preventDefault(),
            jQuery(this).hasClass('mean-clicked') ? (jQuery(this).text(y), jQuery(this).prev('ul').slideUp(300, function () {
